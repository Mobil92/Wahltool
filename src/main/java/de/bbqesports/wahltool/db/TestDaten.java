...
public class TestDaten {
	...
	private void setupBenutzer() {
	 ...
	 abstimmungService
	 .save(new Abstimmung("Abstimmung Nr 1", "Hier geht es um die Abstimmung blabla bla...", false));
	 }
	
	 if (!abstimmungService.findById(2).isPresent()) {
	 abstimmungService.save(
	 new Abstimmung("Abstimmung Nr 2", "Hier geht es um eine andere Abstimmung blabla bla...", true));
	 }
